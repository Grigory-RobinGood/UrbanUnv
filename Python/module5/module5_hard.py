...
class UrTube:
    ...
    def get_videos(self, search_word):
        matching_videos = [video.title for video in self.videos if search_word.lower() in video.title.lower()]
    ...
    def watch_video(self, video_title):
        ...
        for v in self.videos:
            if v.title.lower() == video_title.lower():
                video = v
                break
        ...
        for second in range(video.duration):
            self._wait_one_second()
            video.time_now = second + 1
            print(video.time_now, end=' ')
        print("Конец видео")

    def _wait_one_second(self):
        import time
        time.sleep(1)
