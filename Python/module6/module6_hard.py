...
class Figure:
    ...
    def set_color(self, r, g, b):
        if self.__is_valid_color(r, g, b):
            self.__color = [r, g, b]
        # Если некорректно, ничего не меняем
...
class Circle(Figure):
    ...
    def __init__(self, color, *sides):
        ...
        self.__radius = sides[0] / (2 * math.pi) if sides else 1  # Рассчитываем радиус
...
class Cube(Figure):
    ...
    def __init__(self, color, *sides):
        ...
        if len(sides) == 1:
            ...
            self.__sides = [1] * self.sides_count  # Если сторон больше 1, заполняем единицами
